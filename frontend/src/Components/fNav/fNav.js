...
import { FaTachometerAlt, FaMoneyBillWave, FaRegChartBar, FaChartLine, FaExclamationTriangle, FaSignOutAlt } from "react-icons/fa";
...
function Nav() {
  ...
  const menuItems = [
    ...
    { icon: <FaExclamationTriangle />, label: "Alerts", path: "/alerts" },
