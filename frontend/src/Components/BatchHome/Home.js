          ...
          <div className="w-full max-w-6xl h-[500px] bg-white shadow-lg rounded-lg p-6">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <XAxis dataKey="_id" tickFormatter={formatXAxis} angle={-30} textAnchor="end">
                  <Label value="Batch ID" offset={-40} position="insideBottom" />
                </XAxis>
                <YAxis>
                ...
                <Bar dataKey="quantity" fill="#1d4ed8" radius={[5, 5, 0, 0]} name="Quantity" />
                <Bar dataKey="removedQuantity" fill="#dc2626" radius={[5, 5, 0, 0]} name="Removed" />
                <Bar dataKey="remainingQuantity" fill="#16a34a" radius={[5, 5, 0, 0]} name="Remaining" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        )}
