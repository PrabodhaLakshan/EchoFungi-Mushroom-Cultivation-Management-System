...
function Acontrol() {
    ...
    const saveSettings = async () => {
        try {
            const res = await axios.post('http://localhost:5000/api/temperatureSetting', {
    ...
    return (
        <div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200">
                    <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                        ...
                        <div className="flex-1">
                            <label className="block text-sm font-medium text-gray-700 mb-2">Set Max Temperature (°C)</label>
                        ...
                        <div className="flex items-center gap-4 bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <div className="flex items-center gap-2">
                                <div className={`w-3 h-3 rounded-full ${autoSpray ? 'bg-green-500' : 'bg-gray-400'} animate-pulse`}></div>
                                <span className={`text-sm font-medium ${autoSpray ? 'text-green-600' : 'text-gray-500'}`}>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                <p className="text-gray-700 font-medium">Current Temperature: {currentTemp ? `${currentTemp} °C` : "Loading..."}</p>
